...
export function EducationForm({handleChange, data: {schoolName, major, skills, from, until}, handleAddItem}) {
    return (
        <section className="form">
            ...
            <form>
                ...
                <DynamicInputList type='education' handleAddItem={handleAddItem} data={skills}/>
                <DateInput />
            </form>
        </section>
    )
