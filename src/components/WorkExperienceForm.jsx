...
export function WorkExperienceForm({handleChange, data: {companyName, positionTitle, responsibilities, from, until}, handleAddItem, handleRemoveItem, handleUpdateItem}) {
    return (
        <section className="form">
            ...
            <form>
                ...
                <DateInput type={'work'} handleChange={handleChange} from={from} until={until}/>
            </form>
        </section>
    )
}