...
export function WorkExperienceForm({handleChange, data: {companyName,positionTitle, responsibilities}, handleAddItem}) {
    return (
        <section className="form">
            ...
            <form>
                ...
                <DynamicInputList type='work' data={responsibilities} handleAddItem={handleAddItem}/>
                <DateInput />
            </form>
        </section>
    )
